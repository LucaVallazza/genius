...
export async function POST(req: Request) {
  try {
    ...
    const response = {
      data: {
        output: [
          'https://cdn2.stablediffusionapi.com/generations/3855447c-287a-4b73-9a16-32df87cb9b44-0.png',
          'https://cdn2.stablediffusionapi.com/generations/3855447c-287a-4b73-9a16-32df87cb9b44-1.png',
          'https://cdn2.stablediffusionapi.com/generations/3855447c-287a-4b73-9a16-32df87cb9b44-2.png',
          'https://cdn2.stablediffusionapi.com/generations/3855447c-287a-4b73-9a16-32df87cb9b44-3.png',
          'https://cdn2.stablediffusionapi.com/generations/3855447c-287a-4b73-9a16-32df87cb9b44-1.png'
        ]
      }
    }
    ...
    return NextResponse.json({output: response.data.output.slice(5-samples)});
  } catch (error) {
    // Error handling.
